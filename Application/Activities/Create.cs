...
namespace Application.Activities
{
    public class Create
    {
        ...
        public class Handler : IRequestHandler<Command, Result<Unit>>
        {
            ...
            {
                var user = await _context.Users.FirstOrDefaultAsync(x => x.UserName == _userAccessor.GetUsername()); //gives access to our user object
                // now we can create new attendee based on that info above
